...
multiple_types = Union[str, int, bytes, float]
...
class Cache:
    ...
    def __init__(self):
        """ Instance of Redis db initialization"""
        self._redis = redis.Redis()
        self._redis.flushdb()

    @count_calls
    @call_history
    def store(self, data: multiple_types) -> str:
        """
    ...
    def get(self,
            key: str,
            fn: Optional[Callable] = None) -> multiple_types:
        """
